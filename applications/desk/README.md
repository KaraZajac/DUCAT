...
The desk speaks the phone's twenty languages — English and nineteen
translations, which is the count `strings_from_android.py --check` reports
and the one the rest of the repository uses. Every sentence a page
