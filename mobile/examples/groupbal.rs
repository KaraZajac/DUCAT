fn main() {
    ...
    let r = ducat_mobile::monero::monero_scan_view_only(
        node, "525uzvqwmLVVTGiMhqwizL3dA2hR759wedHo45r8mRRyTTypBS8WHDqarqUDtU8ZyK8fxuz7SxTJyipMtrnB9VxgBEEBqFZ".into(), "7fd37f2640fd7539fb456e138973b48ee4efaae164974002a805f6860cf4ae03".into(), from, (st.height - from) as u32).unwrap();
