...
fn pay(kind: MessageKind, amount: Option<u64>, txid: Option<Vec<u8>>) -> Message {
    Message {
        ...
        kind, amount_pxmr: amount, txid, payto: None, items: Vec::new(), tax_pxmr: None, re_seq: None, re_own: false, eta_secs: None, payload: None, round: None, ceremony_id: None, attachment: None, position: None,
    }
}
