...
| `chat-thread.png` | A conversation carrying money: itemised bill with tax line, receipt, settled-escrow banner |
...
| `group-chat.png` | A group: fan-out over pairwise threads, replies, reactions |
...
| `profile.png` | Profile: what contacts see, all of it optional |
...
| `kiosk-staff.png` | Kiosk staff panel behind the PIN: orders, menu, the tax rate |
