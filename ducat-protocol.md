...
**Draft 1.1.0-dev4 — Publications track (branch; 1.0.0-rc1 is the frozen line)**
...
carries a freshly allocated private-route blob (field 263, 1–1200 bytes —
a measured default-config blob is 832; past the cap something is being
smuggled that is not a route) and a call id (field 264, eight random bytes). A
