...
**Draft 1.1.0-dev5 — Publications track (branch; 1.0.0-rc1 is the frozen line)**
...
speed; silence remains the fallback the watchdog hears. Types above 3
are ignored, not errors: the media channel is two consenting endpoints,
not the sealed wire.
